          ...
          <Grid container spacing={2}>
            <Grid item xs={12} sm={5} md={4}>
              <Box className='username'>
                ...
                <Typography variant='body1'>
                  Your Share Balance : &nbsp;{" "}
                  {userData1?.bnbBalace > 0 ? parseInt(userData1?.bnbBalace) : 0}&nbsp;Share
                </Typography>
            ...
            <Grid item xs={12} sm={7} md={8} align="right">
                ...
                <Grid item xs={12}>
                  ...
                  <FormHelperText error>
                    {(isSubmit && withdrawAmount === "" && (
                      ...
                      (withdrawAmount !== "" &&
                        Number(withdrawAmount) <= 101 && (
                          <Box ml={1}>Withdraw amount should be greator than 101</Box>
                        ))
                      //   ||
                      // (withdrawAmount !== "" &&
