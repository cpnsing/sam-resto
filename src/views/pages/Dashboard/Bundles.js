...
function Collection({ listPublicExclusiveHandler }) {
  ...
  console.log("coverPost", imageurl, coverPost);
  ...
  const createBundleHandle = async (event) => {
    ...
    if (
      ...
      // formData.append("mediaUrl", coverPost);
      // formData.append("postTitle", list);
      // formData.append("collectionId", activities);
      // formData.append("amount", amount);
      // formData.append("tag", selectuser);
      // if(hastag){
      // formData.append("hashTagName", hastag);
                ...
                <Box mt={2}>
                  <TextField
                    ...
                    error={
                      ...
                      (titlePost !== "" && titlePost.length > 60 && titlePost.length < 10)
                    }
